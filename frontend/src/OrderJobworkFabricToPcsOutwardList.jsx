...
function PrintModal({ rec, items, onClose }) {
    ...
    const downloadPDF = () => {
        ...
        const opt = {
            margin: 0,
            filename: `Fabric-Tops-Outward-${rec.outward_no || rec.id}.pdf`,
                        ...
                        <table style={{ width: "100%", borderCollapse: "collapse" }}>
                            ...
                            <tfoot>
                                <tr style={{ background: "#f9fafb", borderTop: "1.5px solid #000" }}>
                                    ...
                                    <td style={{ padding: "10px", textAlign: "right", fontSize: "11px", fontWeight: "900", borderRight: "1.5px solid #000" }}>{totalQty.toFixed(3)} KG</td>
...
export default function OrderJobworkFabricToPcsOutwardList() {
            ...
            <div className="mx-auto" style={{ maxWidth: "1500px" }}>
                <div className="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
                    <div className="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <div className="d-flex align-items-center gap-2 mb-1">
                                ...
                                <span className="badge rounded-pill px-3 py-2 text-white" style={{ background: "#6366f1", fontSize: "0.65rem" }}>Fabric Tops Outward</span>
                            </div>
                    ...
                    <div className="d-flex gap-2">
                        ...
                        <button className="btn btn-primary btn-premium shadow-sm fw-bold" style={{ background: "#6366f1", borderColor: "#6366f1" }} onClick={() => navigate("/order-jobwork-fabric-to-pcs-outward")}>
                ...
                <div className="row g-3 mb-4">
                    {[
                        { label: "Total Outwards", value: records.length, grad: "#6366f1, #4f46e5", icon: "bi-layers" },
                                ...
                                {loading ? (
                                    ...
                                    <React.Fragment key={r.id}>
                                        <tr className={selected.has(r.id) ? "table-light" : ""}>
                                            ...
                                            <td>
                                                <span className="badge rounded-pill px-3 py-2 fw-bold" style={{ background: "#eef2ff", color: "#6366f1", fontSize: '0.75rem' }}>
                                                    {r.outward_no}
                                                </span>
                                            </td>
                                            ...
                                            <td className="text-end pe-4">
                                                <div className="d-flex justify-content-end gap-2">
                                                    ...
                                                    <button className="btn btn-sm btn-light rounded-circle border-0 action-btn p-0"
                                                        style={{ width: 32, height: 32, background: '#eff6ff' }} onClick={() => navigate(`/edit-order-jobwork-fabric-to-pcs-outward/${r.id}`)} title="Edit">
