...
export default function EditOrderJobworkYarnToFabricInward() {
    const { id } = useParams();
    ...
    const fetchData = useCallback(async () => {
        ...
        try {
            ...
            navigate("/order-jobwork-yarn-to-fabric-inward-list");
    ...
    return (
        <div className="container-fluid mt-2 mb-3 px-2 px-md-3">
            ...
            <div className="d-flex align-items-center gap-2 mb-3 pb-2 border-bottom">
                <button className="btn btn-outline-secondary btn-sm rounded-pill px-2" onClick={() => navigate("/order-jobwork-yarn-to-fabric-inward-list")}>
                ...
                <div>
                    <div className="d-flex align-items-center gap-2">
                        ...
                        <span className="badge bg-success-subtle text-success rounded-pill px-2" style={{ fontSize: "0.65rem" }}>{form.process}</span>
                    </div>
                ...
                <div className="ms-auto text-end">
                    <div className="fw-bold text-success fs-6">{inwardNo}</div>
            ...
            <div className="card border-0 shadow-sm rounded-3">
                <div className="card-body p-3">
                    ...
                    <button className="btn btn-outline-success btn-sm rounded-pill w-100 mt-1 mb-3" style={{ borderStyle: "dashed" }} onClick={addRow}>
