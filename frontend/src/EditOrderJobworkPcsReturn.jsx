...
export default function EditOrderJobworkPcsReturn() {
    const navigate = useNavigate();
    const { id } = useParams();
    const { toasts, add: toast, remove } = useToast();
    const [form, setForm] = useState({
        return_date: "", order_no: "", order_name: "", party_name: "", ship_to: "", process: "", previous_process: "", size_chart_name: "", ref_no: "",
    ...
    const fetchData = useCallback(async () => {
        try {
            ...
            setForm({
                return_date: rec.return_date ? rec.return_date.substring(0, 10) : "",
    ...
    const handleUpdate = async () => {
        ...
        try {
            ...
            await axios.put(`${API}/pcs-return/${id}`, payload);
    ...
    if (loading) return <div className="container mt-5 text-center"><div className="spinner-border text-danger"></div></div>;
            ...
            <div className="d-flex align-items-center gap-3 mb-4 pb-3 border-bottom">
                ...
                <div>
                    <div className="d-flex align-items-center gap-2">
                        <span className="badge bg-danger rounded-pill px-3" style={{ fontSize: "0.7rem", letterSpacing: "0.06em" }}>EDIT ORDER JOBWORK</span>
                    ...
                    <h4 className="fw-bold mb-0 mt-1 text-dark">
                        <i className="bi bi-pencil-square me-2 text-danger"></i>Edit Pcs Return
                    </h4>
                </div>
                <div className="ms-auto text-end">
                    <div className="fw-bold text-danger fs-5">{returnNo}</div>
                    <small className="text-muted">Editing Return</small>
                </div>
            </div>
                ...
                <div className="card-body p-4">
                    <div className="row g-3 mb-3">
                        ...
                        <div className="col-md-2">
                            ...
                            <select className={`form-select ${errors.process ? "is-invalid" : ""} fw-bold text-danger`} name="process" value={form.process} onChange={handleHeader}>
                        ...
                        <div className="col-md-2">
                            ...
                            <select className="form-select fw-bold text-danger" name="size_chart_name" value={form.size_chart_name} onChange={handleHeader}>
                                <option value="">— Select —</option>
                        ...
                        <div className="col-md-2">
                            ...
                            <div className="d-flex gap-3 mt-1">
                                ...
                                <div className="form-check">
                                    ...
                                    <label className="form-check-label small fw-bold text-danger" htmlFor="wtContractor">Contractor</label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <button className="btn btn-danger btn-sm rounded-pill px-3" onClick={addRow}>Add Row</button>
                    </div>
                        ...
                        <table className="table table-hover table-bordered align-middle mb-0">
                            ...
                            <tfoot>
                                <tr className="table-light fw-bold">
                                    ...
                                    <td className="text-center text-danger">{totalPcs}</td>
                                    <td></td>
                                </tr>
                            </tfoot>
                        </table>
                    ...
                    <div className="mt-4 pt-3 border-top d-flex gap-2">
                        <button className="btn btn-danger rounded-pill px-5 fw-bold" onClick={handleUpdate} disabled={saving}>
