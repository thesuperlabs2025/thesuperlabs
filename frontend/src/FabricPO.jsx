...
const FabricPO = () => {
    ...
    const [items, setItems] = useState([
        { counts: "", fabric_name: "", color: "", gsm: "", dia: "", rolls: "", req_qty: "", qty: "", rate: "", gst_per: "", total: 0 }
    ]);
        ...
        const fetchInitialData = async () => {
            try {
                const [poRes, supRes, staffRes, orderRes, lotRes] = await Promise.all([
                    axios.get(`${API}/fabric-po/next-no/gen`),
    ...
    const savePO = async () => {
        ...
        setLoading(true);
        try {
            await axios.post(`${API}/fabric-po`, {
                po_no: poNo,
                ...header,
            ...
            toast.success("Fabric PO Created Successfully!");
                ...
                <div className="card-header bg-white py-3 border-bottom shadow-sm">
                    <div className="d-flex justify-content-between align-items-center">
                        ...
                        <div className="text-center flex-grow-1">
                            <h4 className="fw-bold mb-0 text-uppercase tracking-wider">Fabric Purchase Order</h4>
                        </div>
                    ...
                    <div className="d-flex justify-content-end gap-2">
                        ...
                        {selectedYear.is_closed ? (
                            ...
                            <button className="btn btn-success rounded-pill px-4 fw-bold shadow-sm" onClick={savePO} disabled={loading}>
                                <i className="bi bi-check-lg me-2"></i>{loading ? "Saving..." : "Save Fabric PO"}
                            </button>
                        )}
                    </div>
                </div>
