...
const EditTrimsGRN = () => {
    ...
    const addItem = () => {
        setItems([...items, { trims_name: "", color: "", size: "", qty: "" }]);
    };
    ...
    const saveGRN = async () => {
        ...
        try {
            await axios.put(`${API}/trims-grn/${id}`, {
                ...header,
                items,
            });
            toast.success("Trims GRN Updated Successfully!");
            ...
            <div className="card shadow border-0 rounded-4">
                <div className="card-header bg-white py-3 d-flex justify-content-between align-items-center border-bottom-0">
                    <h4 className="mb-0 fw-bold text-primary">
                        <i className="bi bi-pencil-square me-2"></i>Edit Trims GRN
                    </h4>
                ...
                <div className="card-body p-4">
                    ...
                    <div className="d-flex justify-content-end gap-2">
                        <button className="btn btn-secondary rounded-pill px-4" onClick={() => navigate("/trims-grn-list")}>
                            Cancel
                        </button>
                        <button className="btn btn-success rounded-pill px-4 fw-bold" onClick={saveGRN}>
                            <i className="bi bi-check-lg me-2"></i>Update Trims GRN
                        </button>
                    </div>
                </div>
            </div>
