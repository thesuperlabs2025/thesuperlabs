...
function PrintModal({ rec, items, onClose }) {
    ...
    const downloadPDF = () => {
        ...
        const opt = {
            margin: 0,
            filename: `Lot-Jobwork-Fabric-Return-${rec.return_no || rec.id}.pdf`,
                ...
                <div className="fn-no-print d-flex align-items-center justify-content-between px-4 py-3 border-bottom sticky-top bg-white rounded-top-4" style={{ zIndex: 10 }}>
                    <div className="d-flex align-items-center gap-2">
                        ...
                        <div>
                            ...
                            <div className="text-muted" style={{ fontSize: "0.65rem" }}>Professional Lot Return</div>
                        </div>
                    </div>
                ...
                <div id="fn-print-content" style={{ padding: "40px", fontFamily: "'Inter', 'Segoe UI', sans-serif", color: "#000", background: "#fff" }}>
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "30px" }}>
                        ...
                        <div style={{ textAlign: "right" }}>
                            <div style={{ fontSize: "22px", fontWeight: "900", letterSpacing: "1px", textTransform: "uppercase", color: "#dc3545" }}>LOT JOBWORK RETURN</div>
                    ...
                    <div style={{ display: "flex", gap: "20px", marginBottom: "20px" }}>
                        ...
                        <div style={{ flex: 1, border: "1.5px solid #000" }}>
                            ...
                            <div style={{ padding: "12px 15px", fontSize: "11px", lineHeight: "1.8" }}>
                                ...
                                <div style={{ display: "flex" }}><span style={{ width: "110px", fontWeight: "700" }}>Sender:</span> <span>{rec.staff_name || "—"}</span></div>
                            </div>
                        </div>
                    </div>
...
export default function LotJobworkFabricToPcsReturnList() {
    const navigate = useNavigate();
    const today = new Date().toISOString().substring(0, 10);
    const [filters, setFilters] = useState({ from_date: "", to_date: today, party_name: "", return_no: "", lot_no: "" });
    ...
    }, [allRecords, filters.party_name, filters.return_no, filters.lot_no]);

    const handleFilter = e => setFilters(p => ({ ...p, [e.target.name]: e.target.value }));
    const clearFilters = () => setFilters({ from_date: "", to_date: today, party_name: "", return_no: "", lot_no: "" });
        ...
        <div className="container-fluid py-4 min-vh-100 bg-light px-3 px-md-4">
            ...
            <div className="mx-auto" style={{ maxWidth: "1500px" }}>
                    ...
                    <div className="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <div className="d-flex align-items-center gap-2 mb-1">
                                ...
                                <span className="badge rounded-pill px-3 py-2 text-white" style={{ background: "#ef4444", fontSize: "0.65rem" }}>Fabric Tops Return</span>
                            </div>
                            <h2 className="fw-900 mb-0 ls-1 text-dark" style={{ fontSize: "1.75rem" }}>Fabric Return List</h2>
                        </div>
                    </div>
                    <div className="d-flex gap-2">
                        {selected.size > 0 && (
                        ...
                        <button className="btn btn-danger btn-premium shadow-sm fw-bold" style={{ background: "#ef4444", borderColor: "#ef4444" }} onClick={() => navigate("/lot-jobwork-fabric-to-pcs-return")}>
                            <i className="bi bi-plus-lg me-2"></i>New Return
                        </button>
                    </div>
                </div>
                ...
                <div className="row g-3 mb-4">
                    {[
                        { label: "Total Returns", value: records.length, grad: "#ef4444, #dc2626", icon: "bi-layers" },
                ...
                <div className="card mb-4 overflow-hidden">
                    <div className="card-body p-4 bg-white border-bottom">
                        <div className="row g-3">
                            ...
                            <div className="col-md-2">
                                <label className="form-label small fw-bold text-muted mb-2 text-uppercase ls-1" style={{ fontSize: '0.65rem' }}>Return No.</label>
                                <input type="text" className="form-control form-control-premium" name="return_no" value={filters.return_no} onChange={handleFilter} placeholder="Search return..." />
                            </div>
                            <div className="col-md-2">
                                ...
                                {loading ? (
                                    ...
                                    <React.Fragment key={r.id}>
                                        <tr className={selected.has(r.id) ? "table-light" : ""}>
                                            ...
                                            <td>
                                                <span className="badge rounded-pill px-3 py-2 fw-bold" style={{ background: "#fef2f2", color: "#dc3545", fontSize: '0.75rem' }}>
                                                    {r.return_no}
                                                </span>
                                            </td>
                                            ...
                                            <td>
                                                <span className="badge bg-light text-danger fw-bold border rounded-pill px-3" style={{ fontSize: '0.7rem' }}>
                                                    {r.process || "—"}
                                                </span>
                                            </td>
                                            ...
                                            <td className="text-end pe-4">
                                                <div className="d-flex justify-content-end gap-2">
                                                    ...
                                                    <button className="btn btn-sm btn-light rounded-circle border-0 action-btn p-0"
                                                        style={{ width: 32, height: 32, background: '#eff6ff' }} onClick={() => navigate(`/edit-lot-jobwork-fabric-to-pcs-return/${r.id}`)} title="Edit">
                                                ...
                                                <td colSpan={9} className="p-0 border-0">
                                                    <div className="bg-light p-4 mx-4 mb-4 rounded-4 shadow-sm animate__animated animate__fadeIn">
                                                        <div className="mb-3 d-flex justify-content-between align-items-center">
                                                            <h6 className="fw-bold m-0 text-uppercase ls-1 text-danger" style={{ fontSize: '0.75rem' }}>Detailed Item Information</h6>
                                                            ...
                                                            <table className="table table-sm table-hover mb-0">
                                                                <thead className="table-light">
                                                                    <tr style={{ fontSize: "0.65rem" }}>
                                                                        ...
                                                                        <th>FABRIC NAME</th>
                                                                        <th className="text-center">GSM/DIA</th>
