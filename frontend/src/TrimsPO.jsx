...
const TrimsPO = () => {
    ...
    const [items, setItems] = useState([
        { trims_name: "", color: "", size: "", req_qty: "", qty: "", rate: "", gst_per: "", total: 0 }
    ]);
        ...
        const fetchInitialData = async () => {
            try {
                const [poRes, supRes, staffRes, orderRes, lotRes] = await Promise.all([
                    axios.get(`${API}/trims-po/next-no/gen`),
    ...
    const addItem = () => {
        setItems([...items, { trims_name: "", trims_sku: "", color: "", size: "", qty: "", rate: "", gst_per: "", total: 0 }]);
    };
    ...
    const savePO = async () => {
        ...
        try {
            ...
            toast.success("Trims PO Created Successfully!");
            setTimeout(() => navigate('/trims-po-list'), 1500);
        } catch (err) {
            ...
            <div className="card shadow border-0 rounded-4">
                <div className="card-header bg-white py-3 border-bottom shadow-sm">
                    <div className="d-flex justify-content-between align-items-center">
                        ...
                        <div className="text-center flex-grow-1">
                            <h4 className="fw-bold mb-0 text-uppercase tracking-wider">Trims Purchase Order</h4>
                        </div>
                ...
                <div className="card-body p-3">
                    ...
                    <div className="d-flex justify-content-end gap-2">
                        <button className="btn btn-secondary rounded-pill px-4" onClick={() => navigate('/trims-po-list')}>Cancel</button>
                        {selectedYear.is_closed ? (
                            ...
                            <button className="btn btn-success rounded-pill px-4 fw-bold shadow-sm" onClick={savePO} disabled={loading}>
                                <i className="bi bi-check-lg me-2"></i>{loading ? "Saving..." : "Save Trims PO"}
                            </button>
                        )}
                    </div>
                </div>
