...
export default function LotJobworkFabricToPcsInward() {
    ...
    const fetchInitial = useCallback(async () => {
        try {
            const [noRes, lotRes, empRes, procRes] = await Promise.all([
                axios.get(`${API}/fabric-to-pcs-inward/next-no/lot`),
    ...
    const handleSave = async () => {
        ...
        try {
            const res = await axios.post(`${API}/fabric-to-pcs-inward`, {
                inward_type: "lot", ...form,
                total_qty: totalQty, items: form.rows,
            });
            toast(`Saved! Inward No: ${res.data.inward_no}`, "success");
            setTimeout(() => navigate("/lot-jobwork-fabric-to-pcs-inward-list"), 1500);
        } catch (err) {
    ...
    return (
        <div className="container-fluid mt-3 mb-5 px-3 px-md-4">
            ...
            <div className="d-flex align-items-center gap-3 mb-4 pb-3 border-bottom">
                <button className="btn btn-outline-secondary btn-sm rounded-pill px-3" onClick={() => navigate("/lot-jobwork-fabric-to-pcs-inward-list")}>
            ...
            <div className="card border-0 shadow-sm rounded-4">
                <div className="card-body p-4">
                    ...
                    <div className="mt-4 pt-3 border-top d-flex gap-2">
                        ...
                        <button className="btn btn-outline-secondary rounded-pill px-4" onClick={() => navigate("/lot-jobwork-fabric-to-pcs-inward-list")}>Cancel</button>
                    </div>
                </div>
            </div>
        </div>
