...
export default function LotJobworkFabricToPcsOutward() {
    ...
    const fetchInitial = useCallback(async () => {
        try {
            const [noRes, lotRes, empRes, procRes] = await Promise.all([
                axios.get(`${API}/fabric-to-pcs-outward/next-no/lot`),
    ...
    const handleLotSelect = (e) => {
        ...
        const found = lots.find(o => o.lot_no === val);
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            setTimeout(() => navigate("/lot-jobwork-fabric-to-pcs-outward-list"), 1500);
        } catch (err) {
    ...
    return (
        <div className="container-fluid mt-3 mb-5 px-3 px-md-4">
            ...
            <div className="d-flex align-items-center gap-3 mb-4 pb-3 border-bottom">
                <button className="btn btn-outline-secondary btn-sm rounded-pill px-3" onClick={() => navigate("/lot-jobwork-fabric-to-pcs-outward-list")}>
            ...
            <div className="card border-0 shadow-sm rounded-4">
                <div className="card-body p-4">
                    <div className="row g-3 mb-3">
                        ...
                        <div className="col-md-2">
                            ...
                            <select className={`form-select ${errors.lot_no ? "is-invalid" : ""}`} name="lot_no" value={form.lot_no} onChange={handleLotSelect}>
                                ...
                                {lots.map(o => <option key={o.id} value={o.lot_no}>{o.lot_no}</option>)}
                            </select>
                    ...
                    <div className="mt-4 pt-3 border-top d-flex gap-2">
                        ...
                        <button className="btn btn-outline-secondary rounded-pill px-4" onClick={() => navigate("/lot-jobwork-fabric-to-pcs-outward-list")}>Cancel</button>
                    </div>
                </div>
            </div>
        </div>
