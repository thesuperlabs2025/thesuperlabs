...
export default function EditLotJobworkFabricToPcsInward() {
    const { id } = useParams();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.success("Lot Inward updated successfully");
            navigate("/lot-jobwork-fabric-to-pcs-inward-list");
        } catch (err) {
            ...
            <div className="card border-0 shadow-sm rounded-4 mx-auto" style={{ maxWidth: "1200px" }}>
                <div className="card-header bg-white border-0 py-3 px-4 d-flex justify-content-between align-items-center">
                    <div className="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h5 className="fw-bold mb-0 text-success">Edit Lot Fabric Inward</h5>
                            <small className="text-muted">Inward No: <span className="fw-bold text-dark">{form.inward_no}</span></small>
                        </div>
                    </div>
                    <span className="badge bg-success bg-opacity-10 text-success px-3 py-2 rounded-pill">LOT JOBWORK</span>
                </div>
