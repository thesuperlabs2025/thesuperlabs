...
export default function EditOrderJobworkFabricToPcsReturn() {
    const { id } = useParams();
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const [recRes, empRes, procRes, fabRes, supRes] = await Promise.all([
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            navigate("/order-jobwork-fabric-to-pcs-return-list");
        } catch (err) {
            ...
            <div className="card border-0 shadow-sm rounded-4 mx-auto" style={{ maxWidth: "1200px" }}>
                <div className="card-header bg-white border-0 py-3 px-4 d-flex justify-content-between align-items-center">
                    <div className="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h5 className="fw-bold mb-0 text-danger">Edit Order Fabric Return</h5>
                            <small className="text-muted">Return No: <span className="fw-bold text-dark">{form.return_no}</span></small>
                        </div>
                    </div>
                    <span className="badge bg-danger bg-opacity-10 text-danger px-3 py-2 rounded-pill">ORDER JOBWORK</span>
                </div>
                ...
                <div className="card-body p-4">
                    <form onSubmit={handleSubmit} onKeyDown={handleKeyDown}>
                        ...
                        <div className="row g-3 mb-4 p-3 bg-light rounded-4 border mx-0">
                            ...
                            <div className="col-md-2 mt-3 text-truncate">
