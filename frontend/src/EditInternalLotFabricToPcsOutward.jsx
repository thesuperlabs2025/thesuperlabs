...
export default function EditInternalLotFabricToPcsOutward() {
    const navigate = useNavigate();
    const { id } = useParams();
    const { toasts, add: toast, remove } = useToast();
    const [form, setForm] = useState({
        outward_date: "", internal_lot_no: "", internal_lot_name: "", party_name: "", ship_to: "", process: "", ref_no: "",
    ...
    const fetchData = useCallback(async () => {
        try {
            const [recRes, lotRes, empRes, procRes] = await Promise.all([
