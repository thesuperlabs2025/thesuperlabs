...
const EditFabricGRN = () => {
    ...
    const addItem = () => {
        setItems([...items, { counts: "", fabric_name: "", color: "", gsm: "", dia: "", rolls: "", qty: "" }]);
    };
    ...
    const saveGRN = async () => {
        ...
        try {
            await axios.put(`${API}/fabric-grn/${id}`, {
                ...header,
                items,
            });
            toast.success("Fabric GRN Updated Successfully!");
            ...
            <div className="card shadow border-0 rounded-4">
                <div className="card-header bg-white py-3 d-flex justify-content-between align-items-center border-bottom-0">
                    <h4 className="mb-0 fw-bold text-primary">
                        <i className="bi bi-pencil-square me-2"></i>Edit Fabric GRN
                    </h4>
                ...
                <div className="card-body p-4">
                    ...
                    <div className="d-flex justify-content-end gap-2">
                        <button className="btn btn-secondary rounded-pill px-4" onClick={() => navigate("/fabric-grn-list")}>
                            Cancel
                        </button>
                        <button className="btn btn-success rounded-pill px-4 fw-bold" onClick={saveGRN}>
                            <i className="bi bi-check-lg me-2"></i>Update Fabric GRN
                        </button>
                    </div>
                </div>
            </div>
