...
function PrintModal({ rec, items, onClose }) {
    ...
    const downloadPDF = () => {
        const element = document.getElementById('rn-print-content');
        const opt = {
            margin: 0,
            filename: `Fabric-Tops-Return-${rec.return_no || rec.id}.pdf`,
    ...
    return (
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.65)", zIndex: 9999, display: "flex", alignItems: "center", justifyContent: "center", padding: "16px" }}>
            <style>{`
                .rn-print-root { animation: slideUp 0.15s ease-out; }
                @keyframes slideUp { from { transform: translateY(20px); opacity: 0; } to { transform: translateY(0); opacity: 1; } }
                
                @media print {
                    body * { visibility: hidden !important; }
                    .rn-print-root, .rn-print-root * { visibility: visible !important; }
                    .rn-print-root { 
                    ...
                    .rn-no-print { display: none !important; }
            ...
            <div className="rn-print-root bg-white rounded-4 shadow-lg" style={{ width: "100%", maxWidth: "840px", maxHeight: "95vh", overflowY: "auto", display: "flex", flexDirection: "column" }}>

                {/* Toolbar */}
                <div className="rn-no-print d-flex align-items-center justify-content-between px-4 py-3 border-bottom sticky-top bg-white rounded-top-4" style={{ zIndex: 10 }}>
                    <div className="d-flex align-items-center gap-2">
                        ...
                        <div>
                            ...
                            <div className="text-muted" style={{ fontSize: "0.65rem" }}>Professional Fabric Tops Return</div>
                        </div>
                    </div>
                ...
                {/* Content */}
                <div id="rn-print-content" style={{ padding: "40px", fontFamily: "'Inter', 'Segoe UI', sans-serif", color: "#000", background: "#fff" }}>
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "30px" }}>
                        ...
                        <div style={{ textAlign: "right" }}>
                            <div style={{ fontSize: "22px", fontWeight: "900", letterSpacing: "1px", textTransform: "uppercase", color: "#dc3545" }}>FABRIC TOPS RETURN</div>
                    ...
                    <div style={{ display: "flex", gap: "20px", marginBottom: "20px" }}>
                        <div style={{ flex: 1, border: "1.5px solid #000" }}>
                            <div className="print-black-header" style={{ background: "#000", color: "#fff", padding: "6px 15px", fontSize: "11px", fontWeight: "800", textTransform: "uppercase" }}>RETURNED FROM</div>
...
export default function OrderJobworkFabricToPcsReturnList() {
    const navigate = useNavigate();
    const [filters, setFilters] = useState({ from_date: "", to_date: today, party_name: "", return_no: "", order_no: "" });
    ...
    }, [allRecords, filters.party_name, filters.return_no, filters.order_no]);

    const handleFilter = e => setFilters(p => ({ ...p, [e.target.name]: e.target.value }));
    const clearFilters = () => setFilters({ from_date: "", to_date: today, party_name: "", return_no: "", order_no: "" });
            ...
            <div className="mx-auto" style={{ maxWidth: "1500px" }}>
                <div className="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
                    ...
                    <div className="d-flex gap-2">
                        ...
                        <button className="btn btn-danger btn-premium shadow-sm fw-bold" style={{ background: "#ef4444", borderColor: "#ef4444" }} onClick={() => navigate("/order-jobwork-fabric-to-pcs-return")}>
                                        ...
                                        <tr className={selected.has(r.id) ? "table-light" : ""}>
                                            ...
                                            <td className="text-end pe-4">
                                                <div className="d-flex justify-content-end gap-2">
                                                    ...
                                                    <button className="btn btn-sm btn-light rounded-circle border-0 action-btn p-0"
                                                        style={{ width: 32, height: 32, background: '#eff6ff' }} onClick={() => navigate(`/edit-order-jobwork-fabric-to-pcs-return/${r.id}`)} title="Edit">
