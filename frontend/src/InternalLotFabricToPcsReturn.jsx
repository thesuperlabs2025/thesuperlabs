...
export default function InternalLotFabricToPcsReturn() {
    ...
    const fetchInitial = useCallback(async () => {
        try {
            const [noRes, lotRes, empRes, procRes] = await Promise.all([
                axios.get(`${API}/fabric-to-pcs-return/next-no/internal`),
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            setTimeout(() => navigate("/internal-lot-fabric-to-pcs-return-list"), 1500);
        } catch (err) {
    ...
    return (
        <div className="container-fluid mt-3 mb-5 px-3 px-md-4">
            ...
            <div className="d-flex align-items-center gap-3 mb-4 pb-3 border-bottom">
                <button className="btn btn-outline-secondary btn-sm rounded-pill px-3" onClick={() => navigate("/internal-lot-fabric-to-pcs-return-list")}>
            ...
            <div className="card border-0 shadow-sm rounded-4">
                <div className="card-body p-4">
                    ...
                    <div className="mt-4 pt-3 border-top d-flex gap-2">
                        ...
                        <button className="btn btn-outline-secondary rounded-pill px-4" onClick={() => navigate("/internal-lot-fabric-to-pcs-return-list")}>Cancel</button>
                    </div>
                </div>
            </div>
        </div>
