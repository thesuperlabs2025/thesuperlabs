...
export default function InternalLotFabricToPcsOutward() {
    ...
    const fetchInitial = useCallback(async () => {
        try {
            const [noRes, lotRes, empRes, procRes] = await Promise.all([
                axios.get(`${API}/fabric-to-pcs-outward/next-no/internal`),
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            setTimeout(() => navigate("/internal-lot-fabric-to-pcs-outward-list"), 1500);
        } catch (err) {
    ...
    return (
        <div className="container-fluid mt-3 mb-5 px-3 px-md-4">
            ...
            <div className="d-flex align-items-center gap-3 mb-4 pb-3 border-bottom">
                <button className="btn btn-outline-secondary btn-sm rounded-pill px-3" onClick={() => navigate("/internal-lot-fabric-to-pcs-outward-list")}>
                ...
                <div>
                    <div className="d-flex align-items-center gap-2">
                        ...
                        <span className="badge bg-info-subtle text-info rounded-pill px-3" style={{ fontSize: "0.7rem" }}>{form.process}</span>
                    </div>
                    <h4 className="fw-bold mb-0 mt-1 text-dark">
                        <i className="bi bi-box-arrow-up-right me-2 text-primary"></i>Fabric Tops Outward
                    </h4>
                </div>
            ...
            <div className="card border-0 shadow-sm rounded-4">
                <div className="card-body p-4">
                    ...
                    <div className="mt-4 pt-3 border-top d-flex gap-2">
                        ...
                        <button className="btn btn-outline-secondary rounded-pill px-4" onClick={() => navigate("/internal-lot-fabric-to-pcs-outward-list")}>Cancel</button>
                    </div>
                </div>
            </div>
        </div>
