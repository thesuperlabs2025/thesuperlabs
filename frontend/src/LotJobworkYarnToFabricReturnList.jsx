...
function PrintModal({ rec, items, onClose }) {
    ...
    const downloadPDF = () => {
        const element = document.getElementById('ydr-lot-print-content');
        const opt = {
            margin: 0,
            filename: `Lot-Return-${rec.return_no || rec.id}.pdf`,
    ...
    return (
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.65)", zIndex: 9999, display: "flex", alignItems: "center", justifyContent: "center", padding: "16px" }}>
            <style>{`
                ...
                @media print {
                    ...
                    .yd-print-root { 
                        ...
                        background: #fff !important; z-index: 99999 !important; box-shadow: none !important;
                    }
            ...
            <div className="yd-print-root bg-white rounded-4 shadow-lg" style={{ width: "100%", maxWidth: "840px", maxHeight: "95vh", overflowY: "auto", display: "flex", flexDirection: "column" }}>
                ...
                <div className="yd-no-print d-flex align-items-center justify-content-between px-4 py-3 border-bottom sticky-top bg-white rounded-top-4" style={{ zIndex: 10 }}>
                    <div className="d-flex align-items-center gap-2">
                        ...
                        <div>
                            ...
                            <div className="text-muted" style={{ fontSize: "0.65rem" }}>Lot Return</div>
                        </div>
                    </div>
                ...
                {/* Content */}
                <div id="ydr-lot-print-content" style={{ padding: "40px", fontFamily: "'Inter', 'Segoe UI', sans-serif", color: "#000", background: "#fff" }}>
...
export default function LotJobworkYarnToFabricReturnList() {
    ...
    const [filters, setFilters] = useState({ party: "", return_no: "", lot_no: "", from_date: "", to_date: today });
    ...
    }, [allRecords, filters.party, filters.return_no, filters.lot_no]);
        ...
        <div className="container-fluid py-4 px-4 h-100 d-flex flex-column">
            ...
            <div className="d-flex align-items-center justify-content-between mb-4 pb-3 border-bottom flex-wrap gap-3">
                <div className="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h4 className="fw-bold mb-0 text-dark">Lot Yarn to Fabric Return</h4>
                        <div className="text-muted small">Manage and track your lot jobwork returns</div>
                    </div>
                </div>
                <div className="d-flex gap-2 bg-white p-1 rounded-pill shadow-sm border">
                    ...
                    <button className="btn btn-danger rounded-pill px-4 btn-sm fw-bold shadow-sm" onClick={() => navigate("/lot-jobwork-yarn-to-fabric-return")}>
            ...
            <div className="card border-0 shadow-sm rounded-4 mb-4">
                <div className="card-body p-3">
                    <div className="row g-2 align-items-center">
                        ...
                        <div className="col-md-2">
                            <input type="text" className="form-control form-control-sm rounded-pill px-3" placeholder="Lot No" value={filters.lot_no} onChange={e => setFilters(p => ({ ...p, lot_no: e.target.value }))} />
                        </div>
                        <div className="col-md-2">
                            <button className="btn btn-outline-secondary btn-sm rounded-pill w-100" onClick={() => setFilters({ party: "", return_no: "", lot_no: "", from_date: "", to_date: today })}>
                        ...
                        <tbody>
                            {loading ? (
                                ...
                                <tr key={r.id} className={selected.has(r.id) ? "table-light" : ""}>
                                    ...
                                    <td>
                                        <div className="badge bg-secondary-subtle text-secondary me-1">{r.lot_no}</div>
                                    ...
                                    <td className="text-center">
                                        <button className="btn btn-outline-primary btn-sm rounded-circle me-1 border-0 shadow-sm" onClick={() => navigate(`/edit-lot-jobwork-yarn-to-fabric-return/${r.id}`)} title="Edit Record">
