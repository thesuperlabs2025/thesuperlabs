...
export default function EditInternalLotYarnToFabricReturn() {
    const { id } = useParams();
    ...
    const fetchData = useCallback(async () => {
        ...
        try {
            ...
            setForm({
                ...
                internal_lot_no: data.internal_lot_no || "",
                internal_lot_name: data.internal_lot_name || "",
            ...
            navigate("/internal-lot-yarn-to-fabric-return-list");
