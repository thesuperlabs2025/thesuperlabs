...
export default function InternalLotYarnToFabricOutward() {
    ...
    const fetchInitial = useCallback(async () => {
        try {
            const [noRes, lotRes, empRes] = await Promise.all([
                axios.get(`${API}/yarn-dyeing-outward/next-no/internal`),
        ...
        } catch { setOutwardNo("YD-INT-0001"); }
    }, []);
