...
function PrintModal({ rec, items, onClose }) {
    ...
    const downloadPDF = () => {
        ...
        const opt = {
            margin: 0,
            filename: `Lot-Fabric-Tops-Inward-${rec.inward_no || rec.id}.pdf`,
                ...
                <div className="fn-no-print d-flex align-items-center justify-content-between px-4 py-3 border-bottom sticky-top bg-white rounded-top-4" style={{ zIndex: 10 }}>
                    <div className="d-flex align-items-center gap-2">
                        ...
                        <div>
                            ...
                            <div className="text-muted" style={{ fontSize: "0.65rem" }}>Professional Lot Fabric Inward</div>
                        </div>
                    </div>
                ...
                <div id="fn-print-content" style={{ padding: "40px", fontFamily: "'Inter', 'Segoe UI', sans-serif", color: "#000", background: "#fff" }}>
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "30px" }}>
                        ...
                        <div style={{ textAlign: "right" }}>
                            <div style={{ fontSize: "22px", fontWeight: "900", letterSpacing: "1px", textTransform: "uppercase", color: "#198754" }}>LOT FABRIC INWARD</div>
...
export default function LotJobworkFabricToPcsInwardList() {
    const navigate = useNavigate();
    const today = new Date().toISOString().substring(0, 10);
    const [filters, setFilters] = useState({ from_date: "", to_date: today, party_name: "", inward_no: "", lot_no: "" });
    ...
    }, [allRecords, filters.party_name, filters.inward_no, filters.lot_no]);

    const handleFilter = e => setFilters(p => ({ ...p, [e.target.name]: e.target.value }));
    const clearFilters = () => setFilters({ from_date: "", to_date: today, party_name: "", inward_no: "", lot_no: "" });
            ...
            <div className="mx-auto" style={{ maxWidth: "1500px" }}>
                <div className="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
                    ...
                    <div className="d-flex gap-2">
                        ...
                        <button className="btn btn-success btn-premium shadow-sm fw-bold" style={{ background: "#10b981", borderColor: "#10b981" }} onClick={() => navigate("/lot-jobwork-fabric-to-pcs-inward")}>
                                        ...
                                        <tr className={selected.has(r.id) ? "table-light" : ""}>
                                            ...
                                            <td className="text-end pe-4">
                                                <div className="d-flex justify-content-end gap-2">
                                                    ...
                                                    <button className="btn btn-sm btn-light rounded-circle border-0 action-btn p-0"
                                                        style={{ width: 32, height: 32, background: '#eff6ff' }} onClick={() => navigate(`/edit-lot-jobwork-fabric-to-pcs-inward/${r.id}`)} title="Edit">
