...
export default function EditInternalLotFabricToPcsReturn() {
    const { id } = useParams();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.success("Internal Lot Return updated successfully");
            navigate("/internal-lot-fabric-to-pcs-return-list");
        } catch (err) {
            ...
            <div className="card border-0 shadow-sm rounded-4 mx-auto" style={{ maxWidth: "1200px" }}>
                <div className="card-header bg-white border-0 py-3 px-4 d-flex justify-content-between align-items-center">
                    <div className="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h5 className="fw-bold mb-0 text-danger">Edit Internal Lot Fabric Return</h5>
                            <small className="text-muted">Return No: <span className="fw-bold text-dark">{form.return_no}</span></small>
                        </div>
                    </div>
                    <span className="badge bg-danger bg-opacity-10 text-danger px-3 py-2 rounded-pill">INTERNAL LOT</span>
                </div>
