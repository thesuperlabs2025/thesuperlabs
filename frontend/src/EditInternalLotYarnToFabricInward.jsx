...
export default function EditInternalLotYarnToFabricInward() {
    const { id } = useParams();
    ...
    const fetchData = useCallback(async () => {
        ...
        try {
            ...
            navigate("/internal-lot-yarn-to-fabric-inward-list");
    ...
    return (
        <div className="container-fluid mt-3 mb-5 px-3 px-md-4">
            ...
            <div className="d-flex align-items-center gap-3 mb-4 pb-3 border-bottom">
                <button className="btn btn-outline-secondary btn-sm rounded-pill px-3" onClick={() => navigate("/internal-lot-yarn-to-fabric-inward-list")}>
            ...
            <div className="card border-0 shadow-sm rounded-4">
                <div className="card-body p-4">
                    ...
                    <div className="d-flex justify-content-end gap-2 pt-3 border-top">
                        <button className="btn btn-secondary rounded-pill px-4" onClick={() => navigate("/internal-lot-yarn-to-fabric-inward-list")}>
