...
export default function EditOrderJobworkYarnToFabricReturn() {
    const { id } = useParams();
    ...
    const fetchData = useCallback(async () => {
        ...
        try {
            ...
            navigate("/order-jobwork-yarn-to-fabric-return-list");
    ...
    return (
        <div className="container-fluid mt-2 mb-3 px-2 px-md-3">
            ...
            <div className="d-flex align-items-center gap-2 mb-3 pb-2 border-bottom">
                <button className="btn btn-outline-secondary btn-sm rounded-pill px-2" onClick={() => navigate("/order-jobwork-yarn-to-fabric-return-list")}>
                ...
                <div>
                    <div className="d-flex align-items-center gap-2">
                        ...
                        <span className="badge bg-danger-subtle text-danger rounded-pill px-2" style={{ fontSize: "0.65rem" }}>{form.process}</span>
                    </div>
                ...
                <div className="ms-auto text-end">
                    <div className="fw-bold text-danger fs-6">{returnNo}</div>
                ...
                <div className="card-body p-3">
                    ...
                    <div className="row g-2 mb-2">
                        ...
                        <div className="col-md-1">
                            ...
                            <select className="form-select fw-semibold text-danger" name="process" value={form.process} onChange={handleHeader} style={{ fontSize: "0.75rem" }}>
