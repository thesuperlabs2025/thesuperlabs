...
function PrintModal({ rec, items, onClose }) {
    ...
    const downloadPDF = () => {
        ...
        const opt = {
            margin: 0,
            filename: `Internal-Lot-Fabric-Inward-${rec.inward_no || rec.id}.pdf`,
                ...
                <div className="fn-no-print d-flex align-items-center justify-content-between px-4 py-3 border-bottom sticky-top bg-white rounded-top-4" style={{ zIndex: 10 }}>
                    <div className="d-flex align-items-center gap-2">
                        ...
                        <div>
                            ...
                            <div className="text-muted" style={{ fontSize: "0.65rem" }}>Professional Internal Lot Inward</div>
                        </div>
                    </div>
                ...
                <div id="fn-print-content" style={{ padding: "40px", fontFamily: "'Inter', 'Segoe UI', sans-serif", color: "#000", background: "#fff" }}>
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "30px" }}>
                        ...
                        <div style={{ textAlign: "right" }}>
                            <div style={{ fontSize: "22px", fontWeight: "900", letterSpacing: "1px", textTransform: "uppercase", color: "#198754" }}>INTERNAL LOT INWARD</div>
...
export default function InternalLotFabricToPcsInwardList() {
    const navigate = useNavigate();
    const today = new Date().toISOString().substring(0, 10);
    const [filters, setFilters] = useState({ from_date: "", to_date: today, party_name: "", inward_no: "", internal_lot_no: "" });
    ...
    }, [allRecords, filters.party_name, filters.inward_no, filters.internal_lot_no]);

    const handleFilter = e => setFilters(p => ({ ...p, [e.target.name]: e.target.value }));
    const clearFilters = () => setFilters({ from_date: "", to_date: today, party_name: "", inward_no: "", internal_lot_no: "" });
    ...
    return (
        <div className="container-fluid mt-3 mb-5 px-3 px-md-4">
            ...
            <div className="d-flex align-items-center gap-3 mb-4 pb-3 border-bottom">
                ...
                <div>
                    <div className="d-flex align-items-center gap-2">
                        ...
                        <span className="badge rounded-pill px-3 text-white" style={{ background: "#10b981", fontSize: "0.7rem" }}>Internal Lot Inward</span>
                    </div>
                    <h4 className="fw-bold mb-0 mt-1 text-dark">
                        <i className="bi bi-box-arrow-in-down-left me-2 text-success"></i>Internal Lot Inward List
                    </h4>
                </div>
                <div className="ms-auto d-flex gap-2 flex-wrap">
                    ...
                    <button className="btn btn-success rounded-pill px-3 btn-sm fw-bold shadow-sm" onClick={() => navigate("/internal-lot-fabric-to-pcs-inward")}>
            ...
            <div className="card border-0 shadow-sm rounded-4 mb-4">
                <div className="card-body p-3">
                    <div className="row g-2 align-items-end">
                        ...
                        <div className="col-md-2 col-6">
                            <label className="form-label fw-semibold text-muted mb-1" style={{ fontSize: "0.72rem" }}>INWARD NO.</label>
                            <input type="text" className="form-control form-control-sm border-0 bg-light rounded-pill" name="inward_no" value={filters.inward_no} onChange={handleFilter} placeholder="Filter inward..." />
                        </div>
                        <div className="col-md-2 col-6">
            ...
            <div className="row g-3 mb-4">
                {[
                    { label: "Total Inwards", value: records.length, grad: "#198754,#157347", icon: "bi-layers" },
                            ...
                            <tbody>
                                ...
                                {!loading && records.map((r, idx) => (
                                    <React.Fragment key={r.id}>
                                        <tr className={selected.has(r.id) ? "table-success bg-opacity-10" : ""}>
                                            <td className="ps-3">
                                                <input type="checkbox" className="form-check-input mt-0 shadow-none"
                                            ...
                                            <td>
                                                <span className="badge fw-semibold px-2 py-1 rounded-pill"
                                                    style={{ background: "#f0fdf4", color: "#16a34a", fontSize: "0.73rem" }}>
                                                    {r.inward_no}
                                                </span>
                                            </td>
                                            <td className="text-muted">{fmt(r.inward_date)}</td>
                                            ...
                                            <td><span className="badge bg-light text-success border-0 small fw-normal">{r.process || "—"}</span></td>
                                            ...
                                            <td className="text-center">
                                                <div className="d-flex gap-1 justify-content-center">
                                                    <button className="btn btn-sm rounded-circle border-0 action-btn"
                                                        style={{ width: 28, height: 28, padding: 0, background: "#f1f5f9", color: "#16a34a" }}
                                                    ...
                                                    <button className="btn btn-sm rounded-circle border-0 action-btn"
                                                        style={{ width: 28, height: 28, padding: 0, background: "#f0fdf4", color: "#198754" }}
                                                    ...
                                                    <button className="btn btn-sm rounded-circle border-0 action-btn text-warning"
                                                        ...
                                                        title="Edit record" onClick={() => navigate(`/edit-internal-lot-fabric-to-pcs-inward/${r.id}`)}>
                                                ...
                                                <td colSpan={9} className="p-0 border-0">
                                                    <div className="bg-light p-3 mx-3 mb-3 border rounded-4 shadow-sm" style={{ animation: "slideDown 0.2s ease" }}>
                                                        <div className="mb-2 d-flex justify-content-between align-items-center">
                                                            <h6 className="fw-bold m-0 small text-uppercase ls-wide text-success">Item Breakdown</h6>
