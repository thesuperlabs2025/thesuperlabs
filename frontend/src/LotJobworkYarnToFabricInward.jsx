...
const getForm = () => ({
    inward_date: today, lot_no: "", lot_name: "",
...
export default function LotJobworkYarnToFabricInward() {
    ...
    const fetchInitial = useCallback(async () => {
        try {
            const [noRes, lotRes, empRes] = await Promise.all([
                axios.get(`${API}/yarn-dyeing-inward/next-no/lot`),
        ...
        } catch { setInwardNo("YDI-LOT-0001"); }
    }, []);
    ...
    const handleSave = async () => {
        ...
        setSaving(true);
        try {
            const res = await axios.post(`${API}/yarn-dyeing-inward`, { inward_type: "lot", ...form, total_qty: totalQty, items: form.rows });
    ...
    return (
        <div className="container-fluid mt-3 mb-5 px-3 px-md-4">
            ...
            {showLoadModal && <LoadOutwardModal type="lot" no={form.lot_no} process={form.process} onClose={() => setShowLoadModal(false)} onSelect={handleLoadSelect} />}
            <div className="d-flex align-items-center gap-3 mb-4 pb-3 border-bottom">
                <button className="btn btn-outline-secondary btn-sm rounded-pill px-3" onClick={() => navigate("/lot-jobwork-yarn-to-fabric-inward-list")}><i className="bi bi-arrow-left me-1"></i>Back</button>
                <div>
            ...
            <div className="card border-0 shadow-sm rounded-4">
                <div className="card-body p-4">
                    <div className="row g-3 mb-3">
                        ...
                        <div className="col-md-2"><label className="form-label fw-semibold text-muted" style={{ fontSize: "0.8rem" }}>LOT NAME</label><input type="text" className="form-control bg-light" name="lot_name" value={form.lot_name} readOnly={!!form.lot_no} onChange={handleHeader} placeholder="Auto-filled from lot" /></div>
                    ...
                    <div className="row g-3 mb-4">
                        ...
                        <div className="col-md-4 position-relative" ref={shipToRef}>
                            ...
                            <input type="text" className="form-control" name="ship_to" value={form.ship_to} onChange={handleShipToInput} onKeyDown={handleShipToKeyDown} placeholder="Type to search supplier..." autoComplete="off" />
                    ...
                    <div className="d-flex justify-content-end gap-2 pt-3 border-top">
                        ...
                        <button className="btn btn-secondary rounded-pill px-4" onClick={() => navigate("/lot-jobwork-yarn-to-fabric-inward-list")}><i className="bi bi-x-lg me-1"></i>Cancel</button>
