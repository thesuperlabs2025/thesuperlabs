...
const TrimsInwardList = () => {
    ...
    const fetchInwards = async () => {
        setLoading(true);
        try {
            const res = await axios.get(`${API}/trims-direct-inward`);
            setInwards(res.data);
        } catch (err) {
            console.error(err);
    ...
    const handleDelete = async (id) => {
        if (window.confirm("Are you sure you want to delete this inward? Stock will be reversed.")) {
            try {
                await axios.delete(`${API}/trims-direct-inward/${id}`);
            ...
            <div className="mb-3 mx-auto" style={{
                ...
                <div style={{ position: 'relative', zIndex: 1 }}>
                    <div className="d-flex justify-content-between align-items-center flex-wrap gap-3">
                        <div>
                            <h3 className="fw-bold mb-1" style={{ letterSpacing: '-0.02em' }}>Trims Inward</h3>
                            <p className="opacity-75 mb-0 small">Track trims stock entries and gate passes</p>
                        </div>
                        <div className="d-flex gap-2">
                            <motion.button
                                ...
                                onClick={() => navigate("/trims-inward/new")}
                                        ...
                                        <td className="px-4 py-3 text-end">
                                            <div className="d-flex justify-content-end gap-2">
                                                <button
                                                    ...
                                                    onClick={() => navigate("/trims-inward/edit", { state: { id: inward.id } })}
                                                >
...
export default TrimsInwardList;
